...
/* 3. Use a hash table to store the smaller array and check if the larger arrays elements' exist in the hash table.
This will have a linear time complexity of O(m + n).
 */